...
class TestArrayList < TestList
  def test_it
    ...
    test_insert(lambda {|type, fill_elt| Containers::ArrayList.new(type, fill_elt)})
    test_insert_fill_zero(lambda {|type, fill_elt| Containers::ArrayList.new(type, fill_elt)})
    ...
    test_nth(lambda {Containers::ArrayList.new})
    test_nth_negative_index(lambda {Containers::ArrayList.new})
    test_set_nth(lambda {Containers::ArrayList.new})
    test_set_nth_negative_index(lambda {Containers::ArrayList.new})
    test_set_nth_out_of_bounds(lambda {Containers::ArrayList.new})
...
class TestSinglyLinkedList < TestList
  def test_it
    ...
    test_insert(lambda {|type, fill_elt| Containers::SinglyLinkedList.new(type, fill_elt)})
    test_insert_fill_zero(lambda {|type, fill_elt| Containers::SinglyLinkedList.new(type, fill_elt)})
    ...
    test_nth(lambda {Containers::SinglyLinkedList.new})
    test_nth_negative_index(lambda {Containers::SinglyLinkedList.new})
    test_set_nth(lambda {Containers::SinglyLinkedList.new})
    test_set_nth_negative_index(lambda {Containers::SinglyLinkedList.new})
    test_set_nth_out_of_bounds(lambda {Containers::SinglyLinkedList.new})
...
class TestDoublyLinkedList < TestList
  def test_it
    ...
    test_insert(lambda {|type, fill_elt| Containers::DoublyLinkedList.new(type, fill_elt)})
    test_insert_fill_zero(lambda {|type, fill_elt| Containers::DoublyLinkedList.new(type, fill_elt)})
    ...
    test_nth(lambda {Containers::DoublyLinkedList.new})
    test_nth_negative_index(lambda {Containers::DoublyLinkedList.new})
    test_set_nth(lambda {Containers::DoublyLinkedList.new})
    test_set_nth_negative_index(lambda {Containers::DoublyLinkedList.new})
    test_set_nth_out_of_bounds(lambda {Containers::DoublyLinkedList.new})
...
class TestHashList < TestList
  def test_it
    ...
    test_insert(lambda {|type, fill_elt| Containers::HashList.new(type, fill_elt)})
    test_insert_fill_zero(lambda {|type, fill_elt| Containers::HashList.new(type, fill_elt)})
    ...
    test_nth(lambda {Containers::HashList.new})
    test_nth_negative_index(lambda {Containers::HashList.new})
    test_set_nth(lambda {Containers::HashList.new})
    test_set_nth_negative_index(lambda {Containers::HashList.new})
    test_set_nth_out_of_bounds(lambda {Containers::HashList.new})
